...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {audio_mute_tri_io[0]}]; #IO_L23N_T3_34 Sch=AC_MUTEN
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports i2s_1_s_out           ]; #IO_L8P_T1_AD10P_35 Sch=AC_PBDAT
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports i2s_0_ws_out          ]; #IO_L11N_T1_SRCC_35 Sch=AC_PBLRC
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports i2s_0_s_in            ]; #IO_L12P_T1_MRCC_35 Sch=AC_RECDAT
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports i2s_0_ws_out          ]; #IO_L8N_T1_AD10N_35 Sch=AC_RECLRC
